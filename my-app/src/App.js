...
function App() {
  return (
    ...
    <div class="max-w-sm mx-auto flex p-3 border border-white-400 bg-white -lg shadow-xl">
      <div class="flex-shrink-0">
        <img src="https://cdn-icons-png.flaticon.com/512/5703/5703038.png" alt="" class="h-30 w-12" />
      </div>
      <div class="ml-6 pt-1 ">
        <h4 class="text-xl text-gray-900">WELCOME TO THE FUTURESTIC BANK</h4>
